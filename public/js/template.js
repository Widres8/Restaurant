...
$(function() {
    ...
    $('#sidebar-collapse-btn').on('click', function(event) {
        ...
        var classList = containerApp.attr('class').split(/\s+/);

        if (classList.length === 1) {
            containerApp.addClass("sidebar-close");
        } else if (containerApp.hasClass("sidebar-open")) {
            containerApp.removeClass("sidebar-open");
            containerApp.addClass("sidebar-close");
        } else if (containerApp.hasClass("sidebar-close")) {
            containerApp.removeClass("sidebar-close");
            containerApp.addClass("sidebar-open");
        }
    });
