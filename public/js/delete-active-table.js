$(document).ready(function() {
    ...
    $(".tablecontainer").on("click", ".deleteItem", function(e) {
    ...
    var textSwalActive =
        "Este paso habilitara nuevamente el registro en el sistema";
    var typeSwalActive = "info";
    var textButton = "Activar";
    var textclassName = "btn-success";

    $(".tablecontainer").on("click", "changeStatusItem", function(e) {
        var parameterModel = $(this).data("id");
        ...
        if (active == 1) {
            ...
            textSwalActive =
                "Este paso deshabilitara nuevamente el registro en el sistema";
